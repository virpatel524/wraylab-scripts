...
#SBATCH -o  /home/vdp5/slurm_out/OM236_bwa.script.out
...
srun bwa mem -M -t 4 -v 2 -A 2 -L 15 -U 9 -T 75 -k 19 -w 100 -d 100 -r 1.5 -c 10000 -B 4 -O 6 -E 1 /gpfs/fs0/data/wraycompute/vdp5/reference_data/PVP01.fasta /gpfs/fs0/data/wraycompute/vdp5/rest_samples_gz/OM236_1.fastq.gz /gpfs/fs0/data/wraycompute/vdp5/rest_samples_gz/OM236_2.fastq.gz | samtools view  -Sb - | samtools sort - -o /gpfs/fs0/data/wraycompute/vdp5/mapped/OM236.sorted.bam
sbatch -o /home/vdp5/slurm_out/OM236.script.out /home/vdp5/slurm_scripts/nyu_gatk_pipeline.sh /gpfs/fs0/data/wraycompute/vdp5/bin/picard.jar /gpfs/fs0/data/wraycompute/vdp5/bin/GenomeAnalysisTK.jar /gpfs/fs0/data/wraycompute/vdp5/reference_data/PVP01.fasta /gpfs/fs0/data/wraycompute/vdp5/mapped/OM236.sorted.bam
